...
# 数据加载
test_dataset = TestImageDataset(image_dir='/data/coding/pythonProject/BUSI/newtrain/newval')

test_loader = DataLoader(test_dataset, batch_size=16, shuffle=False, num_workers=0)

# 加载模型
model = UNetTaskAligWeight(n_channels=3,n_classes=1).to(device)
checkpoint = torch.load("/data/coding/checkpoint/Zhou/best_model_epoch109.pt", map_location=device)
