    ...
    def __init__(self, image_list, path, img_size=224, crop=None, is_train=None):
        ...
        if is_train:
            self.augm = CDDataAugmentation(img_size=img_size,
                                           ...
                                           p_scale=0.6,
                                           p_gaussn=0.5, p_contr=0.3, p_gama=0.5, p_distor=0.0,
...
def cross_validation(args):
    ...
    for epoch in range(start_epoch,args.epochs):
        ...
        train_loss = train(model,optimizer, train_loader,se_loss,cl_loss,device, epoch)
        val_loss, f1_score,acc_score,auc_score,matrix2_score = val(model,val_loader,se_loss,cl_loss,device)
